...
//concatenação NUNCA USAR
console.log('Usuário: ' + userName + 'Email: ' + userEmail);

// TEMPLATE STRING
// Começar e terminar com o sinal de 
// CRASE `escrever o que quiser`
// Placeholder - chamar variável ${variável}
// Placeholder - chamar método ${Math.random()}
// Placeholder - chamar calcular ${10+10}
